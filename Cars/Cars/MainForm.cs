...
namespace Cars
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            this.cars.Add(new Car("Davi Jones", 300, new DateTime(2010, 1, 1), "Family"));
            this.cars.Add(new Car("Suffle", 350, new DateTime(2010, 1, 1), "Sport"));
            this.cars.Add(new Car("Velina Fabiano", 120, new DateTime(2010, 1, 1), "Truck"));
            this.cars.Add(new Car("Melani", 399, new DateTime(2010, 1, 1), "Family"));
            this.cars.Add(new Car("Jiovanni", 580, new DateTime(2010, 1, 1), "Sport"));
            this.cars.Add(new Car("Innesa", 170, new DateTime(2010, 1, 1), "Truck"));
        ...
        private void createToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (createDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                string type = createDialog.tbMaterial.Text;
